...
public class C extends JFrame  
{
    ...
    public C()  //Constructor
    {
               ...
               JFrame frame = new JFrame("Hostel C");
		...
		Container cn=frame.getContentPane();
                ...
                cn.setLayout(null);
                icon=new ImageIcon("photo/cc.jpg"); //Hostel pic on form
                lpic=new JLabel(icon);
                lpic.setBounds(0,0,375,390);

		panel=new JPanel();
		panel.setBounds(0,0,375,390);
		panel.add(lpic);
		cn.add(panel);
		...
		bdelete=new JButton( "DELETE ");
               ...
               cn.add(lstatus);cn.add(cbstatus/*tstatus*/);cn.add(l1);cn.add(l2);cn.add(bdelete);cn.add(bexit);cn.add(bsave);cn.add(bupdate);
                
 
               cn.setBackground(new Color(220,220,220));  //color code 
               frame.pack();  //bind
       ...
       public void actionPerformed(ActionEvent e)
         {
		   ...
		   str3=tstd_roll.getText();
                   ...
                   statement.executeUpdate("insert into C values('"+str1+"','"+str2+"','"+str3+"','"+str4+"')");
     ...
     public void actionPerformed(ActionEvent e)
       {
	    ...
	    str2=JOptionPane.showInputDialog("Seat Number");
            rs=statement.executeQuery("select * from C where room_no='"+str1+"' and seat_no='"+str2+"'");
            rs.next();
            ...
            statement.executeUpdate("delete from C where room_no='"+str1+"' and seat_no='"+str2+"'");                         
            statement.executeUpdate("Commit");
        ...
        try
           {
            ...
            statement.executeUpdate("update C set std_roll='"+str3+"',status='"+str4+"' where room_no='"+str1+"' and seat_no='"+str2+"'");
            statement.executeUpdate("commit");
