...
String[] stp={"V","F"};
 ...
 public PG2()  //Constructor
        {
                              
             
               JFrame frame = new JFrame("Hostel PG2");
		...
		Container cn=frame.getContentPane();
                ...
                cn.setLayout(null);
                icon=new ImageIcon("photo/pg2.jpg"); //pic on form
                lpic=new JLabel(icon);
                lpic.setBounds(0,0,290,380);

		panel=new JPanel();
		panel.setBounds(5,100,290,380);
		panel.add(lpic);
		cn.add(panel);
               ...
               lhead.setBounds(300,20,910,80);  
                ...
                troom_no.setFont(new Font("Serif",Font.BOLD,25));
		...
		bdelete=new JButton( "DELETE ");
               ...
               bexit.addActionListener(new exitListener(frame));
                ...
                cn.setBackground(new Color(240,240,240));  //color code 
                 frame.pack();  //bind
       ...
       public void actionPerformed(ActionEvent e)
         {
		   ...
		   str3=tstd_roll.getText();
                   ...
                   statement.executeUpdate("insert into PG2 values('"+str1+"','"+str2+"','"+str3+"','"+str4+"')");
     ...
     public void actionPerformed(ActionEvent e)
       {
	    ...
	    str2=JOptionPane.showInputDialog("Seat Number");
             rs=statement.executeQuery("select * from PG2 where room_no='"+str1+"' and seat_no='"+str2+"'");
             rs.next();
            ...
            statement.executeUpdate("delete from PG2 where room_no='"+str1+"' and seat_no='"+str2+"'");                         
            statement.executeUpdate("Commit");
        ...
        try
           {
            ...
            statement.executeUpdate("update PG2 set std_roll='"+str3+"',status='"+str4+"' where room_no='"+str1+"' and seat_no='"+str2+"'");
            statement.executeUpdate("commit");
