...
import java.awt.event.*;
  ...
  public class reportBMH extends JFrame
   {
	...
	public void countRoom()
	{
        try
        {
        rs=statement.executeQuery("select totalSeat,vacentSeat from hostelStatus where hostelName='BMH'");
        rs.next();
