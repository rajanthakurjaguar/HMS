...
import java.awt.event.*;
  ...
  public class reportD extends JFrame
   {
	...
	getContentPane().add(lpic);
		...
		getContentPane().add(wname);
                ...
                wname1 = new JLabel("Mr. Sreenu Naik Bhukya");	
		...
		getContentPane().add(wcontact1);
                ...
                wcontact = new JLabel("9995101708");
	...
	public void countRoom()
	{
        try
        {
        rs=statement.executeQuery("select totalSeat,vacentSeat from hostelStatus where hostelName='D'");
        rs.next();
