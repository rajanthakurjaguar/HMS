  ...
  public class reportE extends JFrame
   {
	...
	getContentPane().add(lpic);
		...
		getContentPane().add(wname);
                ...
                wname1 = new JLabel("Dr.Malladi V Pavan Kumar");	
		...
		getContentPane().add(wcontact1);
                ...
                wcontact = new JLabel("9746920959");
	...
	public void countRoom()
	{
        try
        {
        rs=statement.executeQuery("select totalSeat,vacentSeat from hostelStatus where hostelName='E'");
        rs.next();
