  ...
  public class reportF extends JFrame
   {
	...
	getContentPane().add(lpic);
		...
		getContentPane().add(wname);
                ...
                wname1 = new JLabel("Dr.Rama Subrahmanyam. K");	
                wname1.setFont(new Font("Serif",Font.BOLD,20));
                wname1.setBounds(275,380,350,30);
		...
		getContentPane().add(wcontact1);
                ...
                wcontact = new JLabel("09446063327");
                wcontact.setFont(new Font("Serif",Font.BOLD,20));
                wcontact.setBounds(275,410,200,30);
	...
	public void countRoom()
	{
        try
        {
        rs=statement.executeQuery("select totalSeat,vacentSeat from hostelStatus where hostelName='F'");
        rs.next();
