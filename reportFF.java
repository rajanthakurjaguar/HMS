...
import java.awt.event.*;
  ...
  public class reportFF extends JFrame
   {
	...
	Icon icon=new ImageIcon("photo/ff.jpg");
        JLabel lpic=new JLabel(icon);
        lpic.setBounds(0,-50,650,400);
	getContentPane().add(lpic);
	
               lhead = new JLabel("Hostel FF");
		...
		getContentPane().add(wname);
                ...
                wname1 = new JLabel("Dr.Sunil Mathew");	
		...
		getContentPane().add(wcontact1);
                ...
                wcontact = new JLabel("9349769083");
	...
	public void countRoom()
	{
        try
        {
        rs=statement.executeQuery("select totalSeat,vacentSeat from hostelStatus where hostelName='FF'");
        rs.next();
