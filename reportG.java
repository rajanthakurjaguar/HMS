...
import java.awt.event.*;
  ...
  public class reportG extends JFrame
   {
	...
	getContentPane().add(lpic);
		...
		getContentPane().add(wname);
                ...
                wname1 = new JLabel("Dr. Suresh Kumar");	
		...
		getContentPane().add(wcontact1);
                ...
                wcontact = new JLabel("9447053309");
	...
	public void countRoom()
	{
        try
        {
        rs=statement.executeQuery("select totalSeat,vacentSeat from hostelStatus where hostelName='G'");
        rs.next();
