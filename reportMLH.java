...
import java.awt.event.*;
  ...
  public class reportMLH extends JFrame
   {
	...
	getContentPane().add(lpic);
		...
		getContentPane().add(wcontact1);
                ...
                wcontact = new JLabel("9495892717");
	...
	public void countRoom()
	{
        try
        {
        rs=statement.executeQuery("select totalSeat,vacentSeat from hostelStatus where hostelName='MLH'");
        rs.next();
