...
public class reportPG1 extends JFrame
   {
	...
	Icon icon=new ImageIcon("photo/pg11.jpg");
        JLabel lpic=new JLabel(icon);
        lpic.setBounds(0,-100,650,400);
	getContentPane().add(lpic);
	
               lhead = new JLabel("Hostel PG1");
               lhead.setForeground(Color.red);
               lhead.setFont(new Font("Algerian",Font.BOLD,40));
               lhead.setBounds(180,280,300,80);
		...
		getContentPane().add(wname);
                ...
                wname1 = new JLabel("Dr.V Sivasubramanian");	
                wname1.setFont(new Font("Serif",Font.BOLD,20));
                wname1.setBounds(275,380,300,30);
		...
		getContentPane().add(wcontact1);
                ...
                wcontact = new JLabel("0495-2285406 ");
                wcontact.setFont(new Font("Serif",Font.BOLD,20));
                wcontact.setBounds(275,410,250,30);
	...
	public void countRoom()
	{
        try
        {
        rs=statement.executeQuery("select totalSeat,vacentSeat from hostelStatus where hostelName='PG1'");
        rs.next();
