...
import java.awt.event.*;
  ...
  public class reportPG2 extends JFrame
   {
	...
	getContentPane().add(lpic);
		...
		getContentPane().add(wname);
                ...
                wname1 = new JLabel("Dr. Kodi Ranga Swamy");	
		...
		getContentPane().add(wcontact1);
                ...
                wcontact = new JLabel("9846162955");
	...
	public void countRoom()
	{
        try
        {
        rs=statement.executeQuery("select totalSeat,vacentSeat from hostelStatus where hostelName='PG2'");
        rs.next();
